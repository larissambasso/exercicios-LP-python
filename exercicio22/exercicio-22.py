...
if n2<n1:
  ...
  if n4>n3:
      maior = n4
      print('Os numero em ordem crescente são: ',n1, n2, n3, maior)

  elif n4>n2 and n4<n3:
      print('Os numero em ordem crescente são: ',n1, n2, n4, n3)

  elif n4>n1 and n4<n2:
        print('Os numero em ordem crescente são: ', n1, n4, n2, n3)

  else:
        print('Os numero em ordem crescente são: ',n4,n1,n2,n3)
